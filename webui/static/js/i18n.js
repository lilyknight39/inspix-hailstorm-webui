  ...
  const strings = {
    en: {
      ...
      "view.previewNotGenerated":
        "Preview not generated yet. Auto export runs on page load; click Refresh to retry.",
    ...
    zh: {
      ...
      "view.previewNotGenerated":
        "尚未生成预览（页面加载时已自动运行导出，可点击“刷新预览”重试）。",
    ...
    ja: {
      ...
      "view.previewNotGenerated":
        "プレビュー未生成です。ページ読み込み時に自動エクスポート済みのため、更新で再実行できます。",
